...
spark_locals_without_parens = [
  ...
  audit_log: 1,
  audit_log: 2,
  audit_log_max_failures: 1,
  audit_log_resource: 1,
  audit_log_window: 1,
  auth0: 0,
  auth0: 1,
  auth0: 2,
  auth_method: 1,
  authenticator_attachment: 1,
  authorization_params: 1,
  authorize_url: 1,
  auto_confirm_actions: 1,
  base_url: 1,
  base_url_field: 1,
  brute_force_strategy: 1,
  case_sensitive?: 1,
  ...
  confirm_on_create?: 1,
  confirm_on_update?: 1,
  confirm_setup_action_name: 1,
  confirm_setup_enabled?: 1,
  confirmation: 0,
  confirmation: 1,
  confirmation: 2,
  ...
  include_fields: 1,
  include_purposes: 1,
  include_strategies: 1,
  inhibit_updates?: 1,
  ip_privacy_mode: 1,
  ipv4_truncation_mask: 1,
  ipv6_truncation_mask: 1,
  ...
  recovery_code_resource: 1,
  recovery_codes_relationship_name: 1,
  redirect_uri: 1,
  ...
  revoke_jti_insert_action_name: 1,
  revoke_token_action_name: 1,
  revoke_token_insert_action_name: 1,
  rp_id: 1,
  rp_name: 1,
  secret_field: 1,
  secret_length: 1,
