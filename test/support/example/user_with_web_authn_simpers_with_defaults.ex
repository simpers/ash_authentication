...
defmodule Example.UserWithWebAuthnSimpersWithDefaults do
  defmodule Secret do
    @moduledoc false
  ...
  authentication do
    ...
    strategies do
      web_authn do
        key_resource Example.WebAuthnSimpersKeyWithDefaults
  ...
  relationships do
    has_many :web_authn_keys, Example.WebAuthnSimpersKeyWithDefaults do
