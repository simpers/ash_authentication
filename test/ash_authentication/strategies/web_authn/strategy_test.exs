  ...
  describe "Strategy.routes/1" do
    test "it returns routes for all four phases" do
      ...
      assert Strategy.routes(strategy) == [
               {"/user_with_web_authn_with_defaults/web_authn/register_begin", :register_begin},
               {"/user_with_web_authn_with_defaults/web_authn/register_finish", :register_finish},
               {"/user_with_web_authn_with_defaults/web_authn/sign_in_begin", :sign_in_begin},
               {"/user_with_web_authn_with_defaults/web_authn/sign_in_finish", :sign_in_finish}
             ]
    end
  end
